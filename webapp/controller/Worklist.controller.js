		...
		onUnlistObjects: function() {
			...
			if (aSelectedProducts.length) {
				for (i = 0; i < aSelectedProducts.length; i++) {
					...
					oProductId = oProduct.getBindingContext().getProperty("POID");
			...
			if (aSelectedProducts.length) {
				for (i = 0; i < aSelectedProducts.length; i++) {
					...
					this.getModel().update(sPath, oProductObject, {
						success : this._handleReorderActionResult.bind(this, oProductObject.POID, true, i+1, aSelectedProducts.length),
						error : this._handleReorderActionResult.bind(this, oProductObject.POID, false, i+1, aSelectedProducts.length)
					});
				}
			} else {
				this._showErrorMessage(this.getModel("i18n").getResourceBundle().getText("TableSelectProduct"));
